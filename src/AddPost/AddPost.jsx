...
class AddPost extends Component {
  ...
  handleSubmit = (e) => {
    let url = 'http://192.168.0.128:3500/dashboard/addDetails';
    ...
    return (
      <div className="body-style">
        <div className="container">
          <h2 className="top-header">Add Post</h2>
            ...
            <div className="row">
              ...
              <div className="col-12 col-xs-12 form-group">
                ...
                <div className="custom-file">
                  <input type="file" className="custom-file-input" name="image" id="image" onChange={this.handleFileInput} value={this.state.image} />
                  <label className="custom-file-label" htmlFor="image">{this.state.image === '' ? 'Choose file' : this.state.image}</label>
                </div>
